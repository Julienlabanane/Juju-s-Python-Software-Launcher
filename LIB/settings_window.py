...
def show_settings():
    ...
    settings_window.tk.call("source", "ART/AZURE/azure.tcl")
    settings_window.tk.call("set_theme", current_theme)
    ttk.Label(settings_window, text="Language:").pack(pady=5)
    lang_var = ttk.Combobox(settings_window, values=["en", "fr", "de", "es", "it", "ru"])
